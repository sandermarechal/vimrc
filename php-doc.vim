...
let g:pdv_cfg_Author = "Sander Marechal <s.marechal@jejik.com>"
let g:pdv_cfg_Copyright = "Copyright (C) 2003-2010 Stichting Lone Wolves"
...
func! PhpDocFunc()
    ...
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
    	" Do not add the function name. -- Sander Marechal
...
func! PhpDocClass()
    ...
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
    	" Do not add classname -- Sander Marechal
	exe l:txtBOL . g:pdv_cfg_Comment1 . g:pdv_cfg_EOL
